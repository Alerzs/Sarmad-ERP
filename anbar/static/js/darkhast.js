function toggleSelectAll(selectAllCheckbox) {
    ...
    function toggleSelectAllBoards(selectAllCheckbox) {
    const checkboxes = document.querySelectorAll('#boardPanel input[type="checkbox"][name="board"]');
    checkboxes.forEach(function(checkbox) {
        checkbox.checked = selectAllCheckbox.checked;
    });
}
    ...
    selectAllLabel.innerHTML = `
        <input type="checkbox" id="selectAllBoards" onclick="toggleSelectAllBoards(this)"> Select All
    `
    boardPanel.appendChild(selectAllLabel)
