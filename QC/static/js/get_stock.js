document.addEventListener("DOMContentLoaded", () => {
            ...
            document.addEventListener("click", (e) => {
                if (e.target.classList.contains("add-part-btn")) {
                    ...
                    const part = {
                        designator: row.cells[0].textContent,
                        partnumber: row.cells[1].textContent,
                        codeanbar: row.cells[2].textContent,
                        ordernumber: row.cells[3].textContent,
            ...
            document.querySelectorAll("#resizable-table thead th").forEach(th => {
                ...
                const searchableFields = ["designator", "partnumber", "codeanbar", "ordernumber"];
