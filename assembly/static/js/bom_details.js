document.addEventListener("DOMContentLoaded", () => {
        ...
        function createInput(th, field) {
          ...
          input.style.border = "1px solid #f5a3a3";
          input.style.borderRadius = "4px";
          input.style.backgroundColor = "#ffeaea";
          input.style.color = "#660000";
          ...
          reset.style.border = "1px solid #f5a3a3";
          reset.style.backgroundColor = "#ffd9d9";
          reset.style.color = "#800000";
        ...
        function createStatusFilter(th) {
          ...
          wrapper.style.border = "1px solid #f5a3a3";
        ...
        function updatePagination({ has_previous, has_next, current_page, num_pages }) {
          ...
          wrapper.style.border = "1px solid #f3c4c4";
